...
loc_data_table = {
    ...
    "Chest Opportunity: Home Movies Crate":                         BL2ArchiData("Opportunity", 21, other_req_regions=["WildlifeExploitationPreserve", "ThousandCuts"], jump_z_req=390),
    "Chest Opportunity: Home Movies Upload Room":                   BL2ArchiData("Opportunity", 21, other_req_regions=["WildlifeExploitationPreserve", "ThousandCuts"], jump_z_req=390),
    ...
    "Chest Opportunity: Orbital Delivery Zone":                     BL2ArchiData("Opportunity", 20, other_req_regions=["WildlifeExploitationPreserve", "ThousandCuts"], jump_z_req=390, tags=["missable"]),
